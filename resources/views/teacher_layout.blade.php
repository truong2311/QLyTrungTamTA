    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu extended logout">
                <li><a href="{{URL::to('/logout-teacher')}}"><i class="fa fa-key"></i> Đăng xuất</a></li>
            </ul>
        </li>
    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                <li>
                    <a class="active" href="{{URL::to('/dashboard-teacher')}}">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
                        <li><a href="{{URL::to('/all-classteacher')}}">Xem lớp học</a></li>
                    </ul>
                    <ul class="sub">
                        <li><a href="{{URL::to('/all-lichday')}}">Lịch dạy</a></li>
                    </ul>
                </li>
            </ul>            
        </div>
